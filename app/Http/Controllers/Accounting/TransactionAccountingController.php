...
class TransactionAccountingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $services = $services->where('status', 'paid');
        ...
        $data = [
            ...
            'total_profit' => number_format(((float)$totalProfit + (float) $totalServiceAmount), 2, '.', ''),
            ...
            'service_amount' => number_format($totalServiceAmount, 2)
        ];
